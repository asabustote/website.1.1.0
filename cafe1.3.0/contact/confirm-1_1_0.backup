...
<body>
  <main class="contents">
    <section class="content contact">
      ...
      <form class="contact__form" action="../contact/compleat-1_1_0.php" method="post">
        ...
        <dl class="horizontal-btn-list">
          <dd class="horizontal-btn-list__item">
            <form action="../contact/compleat-1_1_0.php" method="post">
              <input type="hidden" name="ticket" value="<?php echo h($ticket); ?>">
              <button type="submit" class="button-submit horizontal-btn-list__btn">送信</button>
            </form>
          </dd>
          <dd class="horizontal-btn-list__item">
          <form action="../contact/contact-1_1_0.php" method="post">
